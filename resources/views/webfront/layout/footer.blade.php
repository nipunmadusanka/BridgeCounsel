<div class="flex flex-col mx-3 bg-white rounded-lg z-50">
            ...
            <div class="flex flex-col items-center w-full my-20">
                        ...
                        <a href="javascript:void(0)" class="text-grey-700 hover:text-grey-900">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="currentColor" />
                                <mask id="mask0_3320_6483" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="7"
                        ...
                        <a href="javascript:void(0)" class="text-grey-700 hover:text-grey-900">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="currentColor" />
                                <mask id="mask0_3320_6484" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="3"
                ...
                <div class="flex items-center">
                    <p class="text-base font-normal leading-7 text-center text-grey-700">
                        2024 BridgeConsel, All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="flex flex-wrap -mx-3 my-5">
    <div class="w-full max-w-full sm:w-3/4 mx-auto text-center">
        <p class="text-sm text-slate-500 py-1">
            BridgeConsel <a
                href="#"
                class="text-slate-700 hover:text-slate-900" target="_blank">BridgeConsel</a> by <a
                href="#" class="text-slate-700 hover:text-slate-900" target="_blank">BridgeConsel
                BridgeConsel</a>.
        </p>
    </div>
</div>
